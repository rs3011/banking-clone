...
const LoginPage: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: '/public/assets/login_bg.png',
    ...
    >
      ...
      <div className="relative w-full max-w-md px-6 py-8">
        <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-lg shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl">
