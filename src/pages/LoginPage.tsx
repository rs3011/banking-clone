...
const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-2xl px-6 py-8 z-10">
           <div className="mx-auto w-full max-w-md rounded-2xl p-8 shadow-lg bg-white/90 backdrop-blur-sm ring-1 ring-black/10 transition-all duration-300">
