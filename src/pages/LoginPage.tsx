...
const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-2xl px-6 py-8 z-10 rounded-2xl shadow-lg bg-white/90 backdrop-blur-md ring-1 ring-black/10 transition-all duration-300">
